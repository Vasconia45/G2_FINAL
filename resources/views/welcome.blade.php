...
@section('content')
                        ...
                        <div class="carousel-item active">
                            <div class="cards-wrapper d-flex justify-content-around">
                                <div class="cards">
                                    ...
                                    <div class="face back">
                                        @if (auth()->user())
                                            <a href="{{ route('productos_mostrar_lista_productos') }}">
        ...
        <div aria-live="polite" aria-atomic="true" style="position: relative; min-height: 200px;">
            <div class="toast" style="position: fixed; top: 0; right: 0;">
                ...
                <div class="toast-body">
                    <p>@lang('messages.Toast') <a id="link_especial"
                            href="{{ route('register') }}">@lang('messages.Here').</a></p>
                </div>
            </div>
        </div>
    @endif
    ...
    <div class="mt-5" style="margin-top: 200px" id="marcas">
        <div id="carouselExampleControls2" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <h2 class="text-center mt-5" style="color: #CCB26B">@lang('messages.Brand')</h2>
                <hr>
                        ...
                        <div class="carousel-item active">
                            <div class="cards-wrapper d-flex justify-content-around">
                                <div class="cards">
                                    <div class="face front">
                                        @if (auth()->user())
                                            <a href="{{ route('productos_mostrar_lista_productos') }}"><img
